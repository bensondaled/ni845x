...
cdef extern from "ni845x.h":
    ...
    # 
    # DIO functions (BD 2016)
    #
    int32 __stdcall ni845xDioReadLine (
       uInt32 DeviceHandle,
       uInt8 PortNumber,
       uInt8 LineNumber,
       int32 *pReadData
    ...
    int32 __stdcall ni845xDioReadPort (
            uInt32 DeviceHandle,
            uInt8 PortNumber,
            uInt8 *pReadData
            )

    int32 __stdcall ni845xDioWriteLine (
            uInt32 DeviceHandle,
            uInt8 PortNumber,
            uInt8 LineNumber,
            int32 WriteData
    ...
    int32 __stdcall ni845xDioWritePort (
            uInt32 DeviceHandle,
            uInt8 PortNumber,
            uInt8 WriteData
            )
